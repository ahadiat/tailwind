...
const Hero = () => {
  ...
  return (
       ...
       <div className="relative overflow-hidden w-screen h-screen flex justify-center items-center duration-200">
      {/* hero section */}
      <div className="w-screen h-screen relative">
        {/* style bile ade dua elements tp share satu class, then kite nk modify one of them only, so  you need to use style */}
        <Slider {...settings} style={{ padding: '0rem 0' }}  data-aos="zoom-out"
